...
> even 6-month-olds can **discriminate** sets in numerical ratios of 1:2...[but] Condry and Spelke showed children two cards, one with four objects on it and one with eight, and asked *“Which one has four?”* or *“Which one has eight?”* Children were at chance.
...
evidence:
- "one/a" are used equivalently for "one-knowers"
...
> The chimpanzee Ai keeps making mistakes as n-knowers -- everytime she's introduced to a new number, whereas children seldom make such mistakes after they learn 4 (they would be able to understand the difference between N and N+1)

## SUMMARY
### What are the tasks to differentiate relevant cognitive developments? ("milestone tasks"?)
- "differentiation". Behaviorally, habitualization or "select one pile of toys" (chapter 7). Besides correct or not, RT is also important.
  - analog magnitude? if 1:2 can be disfferentiated, then 5:10 should as well. Also, processing RT matters (could be parallel processing).
  - "N-knower"? N+1 and N+2 cannot be distinguished (presumably been similarly represented as "sth > N")
- "count". Behaviorally...don't know how they induce this behavior...
  - signature of having numeral list.
- " identification". "Which is N? which card has N dots?"/"Give me N xxx?"
  - signature of using natural number.
- "self induction/generalization". introduce to new numbers, see how much do you understand about it (by tasks above).

### Fun new questions in this line of research?
- Alternative number concept system? -- Antropology study, "few, more than a few, a lot"
- How does different teaching affect the ability to learn? -- Animal training on number cognition. Eg: chimpanzee Ai, only taught one number at a time, thus never has the chance to generate and use a numeral list.
- How does different language affect the concept learning? -- language without quantifiers, gives people more difficulty?

### Remaining question for me:
- Is language a "cause" of learning, or it's a consequence of some more abstract conceptualization? -- have to be the latter, otherwise how does chinese/japanese learn natural numbers? Then is it really that important?
* on the other hand, why different language have different properties on quantifier?
- Why would people need to learn positive number at all? (then, why negative number? why rational? why real number?...) What is the significance of this task? 
The current learning / testing method are all supervised -- someone already has this ability and tries to teach you. 
- Any normative reason why can't people learn natural numbers from the "analog mapping" route? 
